...
if __name__ == '__main__':
  ...
  MESH = '{}/dgfsurreal5k/mesh/{{0:04d}}.ply'.format(PATH_TO_DATA)
  #smpl_params = sio.loadmat(PARAMS)['params']
  offset = args.offset
  length = args.length
  #smpl_params = smpl_params[offset:(offset+length), :]
  camera = PinholeCamera()
  rotation_path = '{}/dgfsurreal5k/render_rotations'.format(PATH_TO_DATA)
  ...
  render_path = '{}/dgfsurreal5k/scans'.format(PATH_TO_DATA)
  ...
  for mesh_id in range(offset, offset+length):
    ...
    mesh = o3d.io.read_triangle_mesh(MESH.format(mesh_id))
