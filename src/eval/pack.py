...
ASAP='../data/result/{}/ASAP_{{}}.mat'.format(args.dataset)
...
for i in [3100, 5100, 5800]:
#for i in [400, 700, 900]:
  ...
  new_corres = sio.loadmat(ERRORS.format(i))['Idx2'].reshape(-1).astype(np.int32) - 1
  ...
  pred_after.save_to_mat(ASAP.format(i))
